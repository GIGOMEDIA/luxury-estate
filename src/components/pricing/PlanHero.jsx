...
const PlanHero = ({ isAnnual, setIsAnnual, content }) => {
  ...
  return (
    <section className="pt-32 pb-28 px-6 max-w-5xl mx-auto text-center">
      <h1 className="text-4xl md:text-5xl font-black text-[#002045] tracking-tight mb-6 leading-tight">{title}</h1>
      ...
      <div className="flex items-center justify-center gap-5 text-sm font-bold tracking-widest text-slate-400">
        ...
        <span className={isAnnual ? "text-[#002045]" : ""}>ANNUAL ({savingsNote})</span>
      </div>
    </section>
  );
};
